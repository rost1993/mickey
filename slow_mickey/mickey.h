/*
 * This library implements the stream cipher MICKEY 2.0
...
int mickey_set_key_and_iv(struct mickey_context *ctx, const uint8_t *key, const int keylen, const uint8_t iv[10]);
